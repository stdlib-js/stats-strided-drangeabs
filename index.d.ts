...
/**
* Interface describing `drangeabs`.
*/
interface Routine {
	/**
	...
	*/
	...
	/**
	* Computes the range of absolute values of a double-precision floating-point strided array using alternative indexing semantics.
	*
	* @param N - number of indexed elements
	* @param x - input array
	* @param strideX - stride length
